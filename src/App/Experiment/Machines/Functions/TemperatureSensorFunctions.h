...
{
    class TemperatureSensorFunctions : public QObject, public Helpers::FunctionsHelper
    {
        Q_OBJECT

        public:
            TemperatureSensorFunctions(QObject* parent, Settings::Container *settings, Hardware::Access &hardware, QStateMachine& machine, QVariantMap& params, Hardware::CommandConstructor& commandConstructor);
            ~TemperatureSensorFunctions();

...
{
    class EmergancyStopFunctions : public QObject, public Helpers::FunctionsHelper
    {
        Q_OBJECT

        public:
            EmergancyStopFunctions(QObject* parent, Settings::Container *settings, Hardware::Access &hardware, QStateMachine& machine, QVariantMap& params, Hardware::CommandConstructor& commandConstructor);
            ~EmergancyStopFunctions();
        ...
        signals:
            ...
            void emit_pressed(QVariantMap error);
            void emit_notpressed(QVariantMap error);
